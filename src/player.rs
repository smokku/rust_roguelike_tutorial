...
pub fn player_input(gs: &mut State, ctx: &mut Rltk) {
    ...
    match ctx.key {
        ...
        Some(key) => match key {
            VirtualKeyCode::Left => try_move_player(-1, 0, &mut gs.world, &gs.resources),
            VirtualKeyCode::Right => try_move_player(1, 0, &mut gs.world, &gs.resources),
            VirtualKeyCode::Up => try_move_player(0, -1, &mut gs.world, &gs.resources),
            VirtualKeyCode::Down => try_move_player(0, 1, &mut gs.world, &gs.resources),
            _ => {}
        },
    }
}
